...
<html>
    ...
    <body>
        ...
        <ul>
            <li>Do you want to delete a resource? Then, let's use HTML form and use DELETE method.</li>
            <li>Again, not POST, but DELETE.</li>
            <li>Honestly, RESTful is not a standard and technology, thus there is no strict rule which user always uses DELETE method for deleting resource</li>
...
%>
        <form action="http://lvh.me:3000/users/<%= userLink %>.json" method="post">
            ...
            <table border=1 cellpadding=1>
                ...
                <tr>
                    <td>Company</td>
                    <td><%= u.company == null ? "" : u.company %></td>
                </tr>
        ...
        * If you compare two HTML from sources which are used for modification and deletion, the only difference is a hidden field for setting HTTP method.
    </body>
</html>
